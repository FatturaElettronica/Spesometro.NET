...
namespace ComunicazioneFattureEmesseRicevute
{
    public class ComunicazioneFattureEmesseRicevute : BaseClassSerializable
    {
        ...
        public ComunicazioneFattureEmesseRicevute()
        {
